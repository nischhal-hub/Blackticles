     ...
     <motion.div
      ...
      <div className="min-h-screen mt-10">
        <div className='w-[90%] md:w-[60%] mx-auto'>
          ...
          <p className='font-grot font-light text-lg text-center mx-6 mt-2'>Why Ghost (& Figma) instead of Medium, WordPress or other options?</p>
        </div>
        ...
        <div className='w-[90%] md:w-[60%] mt-6 border-t-2 border-black mx-auto'>
          ...
          <div className='flex items-center mt-6 border-t-2 border-slate-400 border-dotted pt-4'>
            ...
            <div className='ml-4 w-[90%]'>
              <p className='font-playFair text-xl md:text-lg'><span className='font-bold font-grot'>Magne Budha </span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, saepe enim nemo blanditiis eum cum.</p>
            </div>
          </div>
        </div>

                                    ...
                                    <motion.div
                                        ...
                                        <div className='w-full m-4 z-50'>
                                            <div className='flex justify-between space-x-2 mb-2'>
                                                <button className='px-2 py-1 bg-accent font-grot text-md w-1/2 font-bold'><span className='flex items-center justify-center'><CiEdit className='text-lg mr-1'/>Edit</span></button>
